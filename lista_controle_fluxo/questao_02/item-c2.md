...
Essa foi uma escolha de projeto em Python para tornar o código mais seguro e 
legível, evitando erros comuns em linguagens como Java e C, onde esquecer um
`break` pode causar comportamentos que não eram esperados.
A ideia é seguir uma lógica de **"um caso, um resultado"**, tornando a 
